...
import { HomeOutlined, DeploymentUnitOutlined, AppstoreOutlined, BookOutlined, UserOutlined, ThunderboltOutlined, CarryOutOutlined } from '@ant-design/icons';
...
const App = () => {
  ...
  const menuItems = useMemo(() => ([
    ...
    { key: '/plan', icon: <CarryOutOutlined />, label: <Link to="/plan">学习计划</Link> },
